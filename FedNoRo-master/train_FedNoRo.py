...
from public_utils.utils.utils import add_noise,set_seed
...
if __name__ == '__main__':
    ...
    #  ------------------------ client selection ------------------------
    # /home/mayali/My_try_code/FedNoRo-master/outputs_ICH_0.4_0.5_0.7/Fed_0.4_0.5_0.7_1/models
    model_path = f"./{models_dir}/stage1_model_{args.s1-1}.pth"
    logging.info(
